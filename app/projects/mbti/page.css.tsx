...
// ── Page root ─────────────────────────────────────────────────────────────────
// Personality palette scoped to this page, following the site theme toggle —
// plum + chartreuse, two deliberately contrasting hues for a study about
// dichotomies. Site tokens are remapped so Navigation and any shared chrome
// inherit the page palette.
...
export const PageRoot = styled.div`
    ...
    --ink-soft: #58525b;
    --ink-mute: #736d76;
    --line: rgba(39, 34, 41, 0.12);
    --line-strong: rgba(39, 34, 41, 0.26);
    --bg: #f9f7f9;
    --bg-soft: #f0edf0;
    --page-card: #fdfcfd;
    --panel-tint: #eee0f1;
...
// ── Hero ──────────────────────────────────────────────────────────────────────
// Fixed art in both themes: the 16-type grid, one cell lit.
...
export const HeroArt = styled.div`
    ...
    z-index: 0;
    background:
        radial-gradient(36% 50% at 70% 30%, rgba(206, 138, 222, 0.16), transparent 70%),
        linear-gradient(176deg, #1f1a21 0%, #1a151b 50%, #151116 80%, var(--bg) 100%);

    &::after {
        content: "";
        position: absolute;
        inset: 0;
        background: linear-gradient(176deg, transparent 48%, rgba(21, 18, 22, 0.3) 76%, var(--bg) 99%);
    }
`
...
/* Hero children use fixed colors — the art doesn't change with theme */
...
export const Eyebrow = styled.div`
    ...
    &::before { content: "◐"; color: var(--spark); font-size: 12px; }
`
...
export const Experiments = styled.div`
    ...
    .k { font-family: ${mono}; font-size: 11px; color: var(--spark); letter-spacing: 0.14em; text-transform: uppercase; margin-bottom: 16px; font-weight: 500; }
    .exp h4 { font-family: ${serif}; font-size: 20px; font-weight: 500; color: var(--ink); margin-bottom: 10px; }
    .exp p { font-size: 14px; color: var(--ink-soft); margin: 0; line-height: 1.6; }
